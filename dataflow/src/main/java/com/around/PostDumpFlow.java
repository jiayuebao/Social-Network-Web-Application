...
public class PostDumpFlow {
    private static final String PROJECT_ID = "boreal-totality-232019";
    ...
    public static void main(String[] args) {
        ...
        // create a big table configuration
        ...
        // https://cloud.google.com/bigtable/docs/dataflow-hbase#reading
        // 1. read big table rows
        PCollection<Result> btRows = p.apply(Read.from(CloudBigtableIO.read(config)));
        // 2. transform to big query rows
